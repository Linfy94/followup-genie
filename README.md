...
> `0.6.0-rc21` · 业务内测版。Hermes + macOS 已实测；WorkBuddy 当前工作空间安装已完成隔离测试，仍待业务电脑实测。
...
✅ **0.6.0-rc21 首次安装已自带核对过的 2026 年预设**：33 个放假日、6 个补班日，
...
见 [KNOWN_ISSUES.md](KNOWN_ISSUES.md)。当前 `0.6.0-rc21` 的主要限制：
